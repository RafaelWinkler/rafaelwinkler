<h1 style="background-image: linear-gradient(to right, #FFC300, #FF5733); -webkit-background-clip: text; color: transparent;">Seja bem-vindo! Sou Rafael Winkler, aqui começa minha jornada como futuro dev!!!</h1>
